...
#Enter your directory into terminal: cd /d G:\My Drive\MatreyekLab_GoogleDrive\Inventories (this helps me to not have to type it every time)
...
#to run program by double-clicking file instead of opening terminal:
#input('Press Enter after you have noted the given information. The window will then disappear.')<-- save for later
